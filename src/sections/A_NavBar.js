		...
		return (
			<CollapsiblesDiv isBlueNav={isBlueNav} isMenuVisible={isMenuVisible}>
				...
				>
				    ...
				    <ListItem><NavButton refID='experiences' text='Experience'/></ListItem>
				    <ListItem><NavButton refID='education' text='Education'/></ListItem>
				    <ListItem><NavButton refID='portfolio' text='Portfolio'/></ListItem>
				    <ListItem><NavButton refID='organizations' text='Organizations'/></ListItem>
				    <ListItem><NavButton refID='hobbies' text='Hobbies'/></ListItem>
				</Scrollspy>
			</CollapsiblesDiv>
		);
	};
			...
			<Nav isBlueNav={isBlueNav}>
				<InnerDiv isBlueNav={isBlueNav}>
					<NameButton onClick={() => smoothScroll('home')}>
						<TYPOGRAPHY.H2 color={COLORS.WHITE}>ZM</TYPOGRAPHY.H2>
					</NameButton>
					<ToggleButton
